...
const projects: Project[] = [
  {
    title: 'SigCRM Pro',
    description: 'Sistema CRM profesional para gestión de clientes, ventas y seguimiento comercial con dashboard analítico.',
    url: 'https://sigcrm.pro/',
    technologies: ['Laravel', 'Livewire', 'NodeJS', 'Python']
  },
  {
    title: 'SoftERP',
